...
import { faHouse, faEllipsis, faMagnifyingGlass} from '@fortawesome/free-solid-svg-icons';
import { faMessage, faSquarePlus, faCompass, faHeart} from '@fortawesome/free-regular-svg-icons';
        ...
        <div className="main">
            <header className="header">
                ...
                <div className="search">
                    <FontAwesomeIcon icon={faMagnifyingGlass} className="icon-ellipsis"/>
            ...
            <div className="prof_nav">
                <div className='post_btns'>
                    <div className="post_btn">
                        ...
                        <g clipPath="url(#clip0_2153_1365)">
